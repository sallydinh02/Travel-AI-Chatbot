...
import 'package:smart_travel_assistant/UI/splash/splashScreen.dart';
import 'firebase_options.dart';
import 'UI/chatbot/chat_ui.dart';
import 'UI/OCR/OCR_ui.dart';
import 'UI/splash/splashScreen.dart';
import 'package:smart_travel_assistant/UI/machine_translate/machine_translate_ui.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //TODO: replace body by login page
      body: Center(
